...
# Optionally, if you set this to "robyrussell", it'll load a random theme each
...
plugins=(git grunt ant adb bower mvn mosh node npm ubuntu tmux dirhistory vi-zsh-mode)
